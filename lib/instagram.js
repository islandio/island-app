    ...
    */
    ...
    Step(
      ...
      function (err, res, body) {
        ...
        // get the default user as the final array element
        db.Members.read({username: 'davegraham'}, group());
      },
      ...
      function (err, memberDocs) {
        ...
        _.each(recentData, function (r, idx) {
          ...
          var member = memberDocs[idx] ? memberDocs[idx] : _.last(memberDocs);
      ...
      function (err, postDocs) {
        ...
        _.each(recentData, function(r, idx) {
          ...
          console.log(postDocs[idx]._id);

          var member = members[idx] ? members[idx] : _.last(members);
