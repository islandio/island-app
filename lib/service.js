...
exports.routes = function (app) {
  ...
  app.get('/embed/:vid', function (req, res) {
    ...
    db.Medias.read({'video.id': req.params.vid}, function (err, med) {
      ...
      var vid = {
        id: med.video.id,
        url: med.video.cf_url || med.video.ssl_url,
        streaming_url: med.video.streaming_url || '',
        ios_url: med.video.ios_url || '',
        poster_url: med.poster.cf_url || med.poster.ssl_url
      };
      res.render('embed', {vid: vid});
    });
  });
