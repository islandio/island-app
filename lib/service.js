...
exports.routes = function (app) {
  ...
  app.get('/service/member.profile/:un', function (req, res) {
    ...
    db.Members.read({username: req.params.un}, function (err, mem) {
      ...
      Step(
        function () {
          db.Comments.list({author_id: mem._id}, {sort: {created: -1},
              limit: 10, inflate: {author: profiles.member,
              post: profiles.post}}, this.parallel());
          db.Posts.list({author_id: mem._id}, {sort: {created: -1},
