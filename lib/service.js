...
exports.routes = function (app) {
  ...
  app.get('/embed/:vid', function (req, res) {
    ...
    db.Medias.read({'video.id': req.params.vid}, function (err, med) {
      if (com.error(err, req, res)) return;
      var params = {
        poster_url: media.video.poster.cf_url || media.video.poster.ssl_url,
        url: media.video.video.cf_url || media.video.video.streaming_url,
        ios_url: media.video.video.ios_url,
        stream: !!media.video.video.streaming_url
      };
      res.render('embed', {media: params});
    });
  });
