  ...
  function getSidebar(member, requestor, types, cb) {
    ...
    var get = {
      ...
      _products: function (cb) {
        ...
        sendowl.products.get(function (err, products) {
          list.products.items = _(products || []).map(function (i) {
            return i.product.product_type === 'tangible' ? i.product: false;
  ...
  app.get('/service/store', function (req, res) {
    ...
    Step(
      function () {
        ...
        getSidebar(req.user, req.user, ['products', 'ticks', 'broadcasts'],
            this.parallel());
