...
exports.collections = {
  ...
  session: {
    resource: true,
    indexes: [{env: 1}, {author_id: 1}, {country_id: 1}, {crag_id: 1}],
  ...
  tick: {
    resource: true,
    indexes: [{type: 1}, {sent: 1}, {author_id: 1}, {country_id: 1},
        {crag_id: 1}, {ascent_id: 1}],
    uniques: [false, false, false, false, false, false]
  },
  subscription: {
