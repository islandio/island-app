...
exports.routes = function (app) {
  ...
  app.post('/api/sessions', function (req, res) {
    ...
    Incoming payload is a session with single action and single tick

    1. determine if there are other sessions for this day
    2. is session at same crag?
    3. if yes, add this tick to session action or create new one if not same
        ...
        Step(
          function () {
            ...
            _.each(actions, function (action) {
              ...
              action.author_id = doc.author._id;
