  ...
  app.post('/api/store/checkout', function (req, res) {
    ...
    Step(
      ...
      function (err, data) {
        ...
        res.send({
          message: 'Huzzah! Thank you for supporting The Island. ' +
        ...
        var email = {
          to: token.email,
          from: 'The Island <sales@island.io>',
          subject: 'Your Island order confirmation (' + order.orderNo + ')'
        };
        email.text = 'Hi ' + shipping.shipTo.name + ',';
        email.text += '\n\n';
        email.text += 'Thank you for placing your order with The Island!';
        email.text += '\n\n';
        ...
        email.text += 'Thank you for supporting The Island. Try hard out there!';
        email.text += '\n\n';
        email.text += 'Cheers,';
        email.text += '\n';
        email.text += 'The Island Team';
