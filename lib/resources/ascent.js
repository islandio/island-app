...
// - If two grades appear the most in the consensus, prefer the one
//   which has an author_id
var calculateGradeByConsensus = exports.calculateGradeByConsensus =
  ...
  // first pass for oldest entry with author_id
  var f = _.find(consensus, function(c) {
    return consensusGrades.indexOf(c.grade) !== -1 && c.author_id;
  });
  if (_.isUndefined(f)) {
...
exports.routes = function () {
  ...
  // there shouldn't be an author associted with this post
